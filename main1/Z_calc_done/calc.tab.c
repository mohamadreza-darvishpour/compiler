...
static const char *const yytname[] =
{
  ...
  "SIZEOF", "STRING", "SWITCH", "TRUE", "EOL", "$accept", "calc", "exp", YY_NULLPTR
};
...
{
       2,   -19,     2,     9,   -18,     3,   -19,   -14,     2,     2,
       2,     2,   -19,   -19,   -19,    -8,    -8,    -8,    -8
};
...
{
       8,     9,    10,    11,     8,     9,    10,    11,     1,     6,
       5,     7,    10,    11,     0,     1,    15,    16,    17,    18,
       0,     8,     9,    10,    11,     2,     0,    13,     0,     0,
       0,    12,     2,     0,     0,    14
};

static const yytype_int8 yycheck[] =
{
      18,    19,    20,    21,    18,    19,    20,    21,     6,     0,
       2,     3,    20,    21,    -1,     6,     8,     9,    10,    11,
      -1,    18,    19,    20,    21,    23,    -1,    24,    -1,    -1,
      -1,    49,    23,    -1,    -1,    49
};
...
{
       0,     6,    23,    51,    52,    52,     0,    52,    18,    19,
      20,    21,    49,    24,    49,    52,    52,    52,    52
};
...
#line 1136 "calc.tab.c"
  ...
  case 4: /* exp: INTEGER  */
#line 45 "calc.y"
                     { (yyval.ival) = (yyvsp[0].ival); printf("Result1: %d\n", (yyvsp[0].ival));}
#line 1142 "calc.tab.c"
    break;

  case 5: /* exp: exp PLUS exp  */
#line 46 "calc.y"
                      { (yyval.ival) = (yyvsp[-2].ival) + (yyvsp[0].ival); printf("Result2: %d\n",  (yyval.ival)); }
#line 1148 "calc.tab.c"
    break;

  case 6: /* exp: exp MINUS exp  */
#line 47 "calc.y"
                    { (yyval.ival) = (yyvsp[-2].ival) - (yyvsp[0].ival); printf("Result3: %d\n",  (yyval.ival));}
#line 1154 "calc.tab.c"
    break;

  case 7: /* exp: exp TIMES exp  */
#line 48 "calc.y"
                    { (yyval.ival) = (yyvsp[-2].ival) * (yyvsp[0].ival); printf("Result4: %d\n",  (yyval.ival));}
...
#line 49 "calc.y"
        ...
        (yyval.ival) = (yyvsp[-2].ival) / (yyvsp[0].ival);printf("Result5: %d\n", (yyval.ival));
    }
#line 1172 "calc.tab.c"
    break;

  case 9: /* exp: LPAREN exp RPAREN  */
#line 56 "calc.y"
